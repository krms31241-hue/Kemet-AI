...
export async function loadManifestFromFile(manifestPath: string): Promise<PluginManifest> {
...
export function loadManifestFromObject(candidate: unknown): PluginManifest {
